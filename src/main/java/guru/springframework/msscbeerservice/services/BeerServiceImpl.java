...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerDto getById(UUID beerId, boolean showInventoryOnHand) {
        return showInventoryOnHand ?
                beerMapper.beerToBeerDtoWithInventoryOnHand(beerRepository.findById(beerId)
                .orElseThrow(NotFoundException::new)) :
                beerMapper.beerToBeerDto(beerRepository.findById(beerId)
                .orElseThrow(NotFoundException::new));
    }
    ...
    public BeerDto getByUpc(String upc, boolean showInventoryOnHand) {
        return showInventoryOnHand ?
                beerMapper.beerToBeerDtoWithInventoryOnHand(beerRepository.findByUpc(upc)
                        .orElseThrow(NotFoundException::new)) :
